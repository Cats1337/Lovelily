 ...
 * @since 2.6.0
 */
define( 'AUTH_KEY',         getenv_docker( 'CLASSICPRESS_AUTH_KEY',         '5e17e5a45b463704db64ff06de7c135462f84606' ) );
define( 'SECURE_AUTH_KEY',  getenv_docker( 'CLASSICPRESS_SECURE_AUTH_KEY',  '16d18d04679b366ded92b12b48eec653f43b758c' ) );
define( 'LOGGED_IN_KEY',    getenv_docker( 'CLASSICPRESS_LOGGED_IN_KEY',    '34369848ba0a1ba846a70fdb1f2eb77549e25efa' ) );
define( 'NONCE_KEY',        getenv_docker( 'CLASSICPRESS_NONCE_KEY',        'fe4e08fc36e87ded09cf035cd2412d0c1febcf79' ) );
define( 'AUTH_SALT',        getenv_docker( 'CLASSICPRESS_AUTH_SALT',        '0ba93d618244809187bd9f2f6564978330bf1d00' ) );
define( 'SECURE_AUTH_SALT', getenv_docker( 'CLASSICPRESS_SECURE_AUTH_SALT', 'becc8ace9e3e7ab8cc5d75dad2d36c682d1305cf' ) );
define( 'LOGGED_IN_SALT',   getenv_docker( 'CLASSICPRESS_LOGGED_IN_SALT',   'ebcaa5662414e2b2fe357b103e48fa13e308cef9' ) );
define( 'NONCE_SALT',       getenv_docker( 'CLASSICPRESS_NONCE_SALT',       'f3b75b2cd48329c432a9c839df5d68e7faef28de' ) );
